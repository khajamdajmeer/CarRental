...
const Home = () => {
    return (
        ...
        <div className="container-fluid  d-flex flex-column-reverse flex-md-row cheight p-0  justify-content-center w-100 ">
            ...
            <div className="container-fluid bg-success px-0 d-flex w-45 flex-column justify-content-center align-items-center ">
                ...
                <div className="d-flex w-100  justify-content-start my-4">
                    <button className='btn btn-light text-success mx-4 my-2'>Book Now</button>
                    <button className='btn btn-secondary text-success mx-4 my-2'>Learn More</button>
                </div>
            </div>
